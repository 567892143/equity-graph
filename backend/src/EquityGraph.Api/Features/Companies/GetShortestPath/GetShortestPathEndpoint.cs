...
/// <summary>Defines endpoint mappings for discovering shortest paths between companies.</summary>
public static class GetShortestPathEndpoint
{
    /// <summary>Maps the GET /api/companies/shortest-path endpoint to the routing pipeline.</summary>
